...
test_that("Occurrence_Hour is within valid range (0-23)", {
  expect_true(
    all(simulated_data$Occurrence_Hour >= 0 & simulated_data$Occurrence_Hour <= 23),
...
test_that("Occurrence_Month is within valid range (1-12)", {
  expect_true(
    all(simulated_data$Occurrence_Month >= 1 & simulated_data$Occurrence_Month <= 12),
...
test_that("Bike_Cost is non-negative", {
  expect_true(
    all(simulated_data$Bike_Cost >= 0),
